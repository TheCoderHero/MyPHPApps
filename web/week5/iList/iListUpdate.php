<?php
	...
	$priority_num = htmlspecialchars($_POST['priority_num']);

	$statement = $db->prepare(" UPDATE ISSUES SET priority_num = " . $priority_num . ", employee_id = 1, submit = CURRENT_DATE, issue = '" . $issue . "' WHERE issue_id = " . $issue_id );
	$statement->execute();
	...
	<body class="w3-black">
		...
		<div class="w3-container w3-blue-gray w3-margin w3-padding-24">
			...
			<div class="w3-row-padding w3-center w3-padding-16">
				<h1 class="shadow">EOS Issue Updated!</h1>
			</div>
