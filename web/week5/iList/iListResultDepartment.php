	...
	<body class="w3-black">
		...
		<div class="w3-container w3-blue-gray w3-margin w3-padding-24">
			...
			<div class="w3-row-padding w3-center w3-padding-16">
				...
				<p class="subheading">search results by department</p>
			</div>
			...
			<div class="w3-responsive w3-text-black">
				<table class="w3-table-all w3-hoverable w3-card-4">
					...
					<?php
						$query = "SELECT * FROM ISSUES JOIN EMPLOYEES USING (EMPLOYEE_ID) JOIN DEPARTMENTS USING (DEPARTMENT_ID) WHERE department_id = " . $search . " ORDER BY PRIORITY_NUM ASC";
