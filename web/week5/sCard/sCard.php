	...
	<body class="w3-black">
		...
		<div class="w3-container w3-blue-gray w3-margin w3-padding-24">
			...
			<div class="w3-container w3-orange w3-margin-top">
				<h2>Submit A New Scorecard</h2>
			</div>
			<form class="w3-container w3-grey w3-padding-16">
				<div class="w3-row">
					<div class="w3-half">
				...
				<label class="w3-text-orange"><b>Measurable</b></label>
				<input class="w3-input w3-border w3-light-grey" type="text">

				<label class="w3-text-orange"><b>Goal</b></label>
