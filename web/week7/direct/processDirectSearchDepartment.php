<?php
    ...
    $query = "SELECT * FROM EMPLOYEES INNER JOIN DEPARTMENTS ON EMPLOYEES.DEPARTMENT_ID = DEPARTMENTS.DEPARTMENT_ID WHERE EMPLOYEES.DEPARTMENT_ID = " . $department . "ORDER BY EMPLOYEE_ID";
    ...
    if($access == "1"){
        ...
        echo '<tr><td colspan = "6">Add Employee Below</td></tr>';
			echo '<tr>';
				...
				echo '<td id="department" contenteditable></td>';
