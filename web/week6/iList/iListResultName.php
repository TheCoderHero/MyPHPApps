<?php
	...
	$statement = $db->prepare("SELECT * FROM ISSUES WHERE L_NAME = '" . $l_name . "' ORDER BY PRIORITY_NUM ASC");
	$statement->execute();

	$rows = $db->prepare("SELECT * FROM ISSUES WHERE L_NAME = '" . $l_name . "' ORDER BY PRIORITY_NUM ASC");
	$rows->execute();
